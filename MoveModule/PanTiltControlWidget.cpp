...
void PanTiltControlWidget::setupUi() {
    ...
    QPixmap panTiltPixmap(":/images/icons/background.png");
...
void PanTiltControlWidget::setButtonStyles() {
    ...
    upButton->setStyleSheet(commonStyle + QString("QPushButton { image: url(:/icons/icons/button_up.svg); image-size: %1px %2px; }").arg(btnWidth).arg(btnHeight));
    downButton->setStyleSheet(commonStyle + QString("QPushButton { image: url(:/icons/icons/button_down.svg); image-size: %1px %2px; }").arg(btnWidth).arg(btnHeight));
    leftButton->setStyleSheet(commonStyle + QString("QPushButton { image: url(:/icons/icons/button_left.svg); image-size: %1px %2px; }").arg(btnWidth).arg(btnHeight));
    rightButton->setStyleSheet(commonStyle + QString("QPushButton { image: url(:/icons/icons/button_right.svg); image-size: %1px %2px; }").arg(btnWidth).arg(btnHeight));

    // 对于斜向按钮，需要设置对应的图标
    upLeftButton->setStyleSheet(commonStyle + QString("QPushButton { image: url(:/icons/icons/button_left_up.svg); image-size: %1px %2px; }").arg(btnWidth).arg(btnHeight));
    upRightButton->setStyleSheet(commonStyle + QString("QPushButton { image: url(:/icons/icons/button_right_up.svg); image-size: %1px %2px; }").arg(btnWidth).arg(btnHeight));
    downLeftButton->setStyleSheet(commonStyle + QString("QPushButton { image: url(:/icons/icons/button_left_down.svg); image-size: %1px %2px; }").arg(btnWidth).arg(btnHeight));
    downRightButton->setStyleSheet(commonStyle + QString("QPushButton { image: url(:/icons/icons/button_right_down.svg); image-size: %1px %2px; }").arg(btnWidth).arg(btnHeight));

    // 重置按钮
    resetButton->setStyleSheet(commonStyle + QString("QPushButton { image: url(:/icons/icons/button_reset.svg); image-size: %1px %2px; }").arg(btnWidth).arg(btnHeight));
}
