...
#include <memory>
#include "../../Users_Login_UI/TitleBar.h"
...
QT_MOC_LITERAL(1, 9, 8), // "sigClose"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 13) // "onClickedSlot"

    },
    "TitleBar\0sigClose\0\0onClickedSlot"
};
...
void TitleBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TitleBar::sigClose)) {
                *result = 0;
                return;
            }
        }
